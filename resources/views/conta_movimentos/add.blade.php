	...
	<div class="box box-default">
      ...
      <div class="box-body">
        <div class="card-body">
          ...
          @endif
	        <form action="/accounts/create" role="form" method="POST">
	            <input type="hidden" name="_token" value="{{ csrf_token() }}">
	            <div class="row">
		            <div class="col-md-6 offset-md-3">
		              <div class="form-group">
		               <label for="Title">Titular</label>
						    <input type="text" class="form-control" name="titular" placeholder="Digite o titular da conta">
		              </div>
		            </div>
		            ...
		            <div class="col-md-6 offset-md-3">
		              <div class="form-group">
		               <label for="Title">Agência</label>
						    <input type="text" class="form-control" name="agencia" placeholder="Digite a agência da conta">
		              </div>
		            </div>
	            ...
	            <div class="row">
		            <div class="col-md-6 offset-md-3">
		              <div class="form-group">
		               <label for="Title">Número da Conta</label>
						    <input type="text" class="form-control" name="numero" placeholder="Digite o número da conta">
		              </div>
		            </div>
		         ...
		         <div class="row">
          		...
          		<div>
        			...
        			<a class="btn btn-default" href="/documents/index">Voltar</a>
          		</div>
          	</form>
      	  </div>
        </div>
