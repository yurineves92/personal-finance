	...
	<div class="box box-default">
      ...
      <div class="box-body">
        <div class="card-body">
          ...
          @endif
	        <form action="/category/update/{{$category->id}}" role="form" method="POST">
	            <input type="hidden" name="_token" value="{{ csrf_token() }}">
	            <div class="row">
		            <div class="col-md-6 offset-md-3">
		              <div class="form-group">
		               <label for="Title">Nome</label>
						    <input type="text" class="form-control" name="nome" value="{{$category->nome}}" placeholder="Digite o nome da categoria">
		              </div>
		            </div>
		            @if ($errors->has('nome'))
